...
============
    ...
    git clone git@github.com:electionr/rootstrikers-wikipedia.git
    rootstrikers-wikipedia/
    git submodule init
...
Run the script fech.py with the year/filename as the filter for the first
argument, so :

    fech.py 2014

will process the year 2014.
